...
Example:
    - generate_flags(theme="Hackaton", tone="neutral", amt=1, 
        model="gpt-4o-mini", flag_format="ctf{..}", response_format="JSON", 
        language="es-PR", additional_instructions="flags must be less than 50 characters",
...
def generate_flags(
    ...
    Args:
        ...
        response_format (str): Format to use for providing the response. Defaults to JSON.
